...
public class GameRequestControllerTest {
    ...
    void getSendReqests() throws  Exception{
        ...
        when(gameRequestService.getMySendGameRequest(1L))
                .thenReturn(List.of(new RequestGameDto( RequestStatus.WAITING, 1L, 2L, 1L, "abc")));
    ...
    void getReceivedReqests() throws Exception{
        ...
        when(gameRequestService.getReceivedGameRequest(2L))
                .thenReturn(List.of(new RequestGameDto( RequestStatus.WAITING, 1L, 2L, 1L, "abc")));
