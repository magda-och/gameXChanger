                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="register-form" id="register-form">
                            <div className="mb-3">
                                ...
                                {errors.firstName?.type === 'required' &&
                                    <p id='alert-msg' role="alert">First name is required</p>}
                                {errors.firstName?.type === 'minLength' &&
                                    <p id='alert-msg' role="alert">First name should be at least 3 characters long</p>}
                                {errors.firstName?.type === 'pattern' &&
                                    <p id="alert-msg" role="alert">First name is not valid - should contains only
                                        letters </p>}
                            </div>
                            <div className="mb-3">
                                ...
                                {errors.lastName?.type === 'required' &&
                                    <p id='alert-msg' role="alert">Last name is required</p>}
                                {errors.lastName?.type === 'minLength' &&
                                    <p id='alert-msg' role="alert">Last name should be at least 3 characters long</p>}
                                {errors.lastName?.type === 'pattern' &&
                                    <p id="alert-msg" role="alert">Last name is not valid - should contains only
                                        letters </p>}
                            </div>
                            <div className="mb-3">
                                ...
                                {errors.email?.type === 'required' &&
                                    <p id='alert-msg' role="alert">Email is required</p>}
                                {errors.email?.type === 'pattern' &&
                                    <p id='alert-msg' role="alert">Email is not valid</p>}
                            </div>
                            <div className="mb-3">
                                ...
                                <div className="password-box">
                                    ...
                                    {errors.password?.type === 'required' &&
                                        <p id='alert-msg' role="alert">Password is required</p>}
                                    {errors.password?.type === 'minLength' &&
                                        <p id='alert-msg' role="alert">Password should have min 6 characters</p>}
                                    {errors.password?.type === 'pattern' &&
                                        <p id='alert-msg' role="alert">Password should have minimum one small letter,
                                            one capital, one
                                            number
                            ...
                            <div className="mb-3">
                                ...
                                {errors.city?.type === 'pattern' &&
                                    <p id="alert-msg" role="alert">City is not valid - should contains only
                                        letters </p>}
                            </div>
                            <div className="mb-3">
                                ...
                                {errors.phoneNumber?.type === 'minLength' &&
                                    <p id='alert-msg' role="alert">Phone number should be at least 9 characters
                                        long</p>}
                                {errors.phoneNumber?.type === 'pattern' &&
                                    <p id="alert-msg" role="alert">Phone number is not valid - should contains only
                                        digits </p>}
                            </div>
